...
like_button ="<button class= 'btn btn-warning' id="+firebase_message_id+" value="+like+"onclick='updateLike(this.id)'</span></button><hr>";
  span_with_tag = "<span class='glyphicon glyphicon-thumbps-up'>Like: "+like +"</span></button><hr>";
